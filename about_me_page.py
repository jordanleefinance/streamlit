...
with st.container():
    ...
    with text_col:
        st.write(
    "Thank you for your time! My name is Jordan Lee, I am financial enthusiast, owner of [JMM Group](https://www.jmmgrp.com/index.html), and a partner at a business information systems and process consulting firm. I obtained my Bachelor's degree in Finance and Information Science, as well as a Master's degree in Financial Analysis from Christopher Newport University. My primary objective is to empower entrepreneurs by supporting them in conceptualizing, synthesizing, and achieving their business objectives, assuming the roles of financial quarterback, stress reliever, and advocate for growth."
